const PG_CODE = 'bank_soal_bahasa_indonesia_200826';
        ...
        function updateCapaianPembelajaran() {
            ...
            if (status) {
                status.textContent = 'CP resmi Bahasa Indonesia diperbarui otomatis berdasarkan fase yang dipilih.';
        ...
        function loadContohBahasaIndonesiaKelas3() {
            ...
            document.getElementById('mata_pelajaran').value = 'Bahasa Indonesia';
            document.getElementById('bab_ke').value = 'BAB 1';
            document.getElementById('judul_bab').value = 'Ayo, Mengenal Lingkungan Sekitar';
            document.getElementById('topik_unit').value = 'Menemukan ide pokok dan informasi penting dalam teks sederhana tentang lingkungan sekitar, menceritakan kembali isi teks, serta menulis tanggapan sederhana sesuai konteks';
            document.getElementById('capaian_pembelajaran').value = CAPAIAN_PEMBELAJARAN.B;
            document.getElementById('tujuan_pembelajaran').value = 'Memahami ide pokok dan informasi penting dari teks sastra dan nonsastra sederhana, menceritakan kembali isi teks, serta menulis tanggapan sederhana dengan kosakata dan kaidah kebahasaan sesuai konteks.';
            document.getElementById('indikator_soal').value = 'Peserta didik mampu menentukan ide pokok, menemukan informasi penting, mengidentifikasi kosakata baru, menceritakan kembali isi teks, serta menulis tanggapan sederhana dengan pilihan kata dan kaidah kebahasaan yang sesuai.';
            ...
            document.getElementById('fokus_file_referensi').value = 'Ide pokok, informasi penting, kosakata baru, isi teks, dan penulisan tanggapan sederhana sesuai materi pada Bab 1';
            ...
            updateJumlahSoalTotal();
            updateCapaianPembelajaran();
            showValidation('Contoh Bahasa Indonesia Kelas 3 Bab 1 berhasil dimuat.', false);
            saveFormState();
        }

        function clearForm() {
            localStorage.removeItem(AUTOSAVE_KEY);
            loadContohBahasaIndonesiaKelas3();
            document.getElementById('nama_sekolah').value = '';
            document.getElementById('outputPrompt').textContent = 'Formulir telah direset ke contoh Bahasa Indonesia Kelas 3 Bab 1.';
            hideValidation();
            saveFormState();
        }
        ...
        function generatePromptBankSoal() {
            ...
            const prompt = `Bertindaklah sebagai pakar pembelajaran Bahasa Indonesia, ahli evaluasi pendidikan, dan penyusun bank soal Kurikulum Merdeka yang teliti. Susun bank soal yang valid, komunikatif, sesuai fase perkembangan literasi, kontekstual, dan siap digunakan berdasarkan parameter berikut.

### 0. ATURAN SUMBER MATERI - WAJIB
- Jika file materi ajar dilampirkan dalam percakapan ini, baca file tersebut terlebih dahulu dan jadikan sebagai ACUAN UTAMA. Jangan mengarang isi teks, fakta, konsep, kaidah kebahasaan, unsur sastra, jenis/struktur teks, kosakata, atau materi di luar cakupan file.
- Nama file yang diharapkan: ${namaPdf}
- Bagian rujukan: ${babSumber}; ${halamanSumber}
- Fokus materi: ${fokusFile}
- CP pada formulir dipetakan otomatis dari dokumen resmi Bahasa Indonesia sesuai fase. Selaraskan TP dan indikator dengan CP tersebut serta isi file materi yang dilampirkan; jangan memperluas soal keluar dari materi file.
...
- Pastikan ejaan, diksi, tata bahasa, kalimat efektif, tanda baca, kaidah kebahasaan, struktur dan isi teks, unsur sastra, serta penggunaan Bahasa Indonesia akurat dan sesuai tingkat kemampuan murid.
- Gunakan konteks yang santun, inklusif, komunikatif, menghargai keragaman bahasa dan budaya Indonesia, serta relevan dengan kehidupan murid.
...
${formatOutput.includes('.docx') ? 'Buat hasil akhir sebagai file Microsoft Word (.docx) yang rapi, siap diunduh, dengan tabel yang tidak terpotong. Lampirkan file tersebut pada jawaban.' : 'Tampilkan hasil lengkap langsung dalam percakapan tanpa placeholder atau bagian yang terpotong.'}`;
        ...
        function downloadPromptTxt() {
            ...
            link.href = url;
            link.download = 'prompt-bank-soal-bahasa-indonesia.txt';
