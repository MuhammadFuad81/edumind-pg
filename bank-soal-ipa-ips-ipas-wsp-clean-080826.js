// ================= IDENTITAS PG & SESSION =================
        ...
        function clearForm() {
            ...
            ['stimulus_soal', 'bahasa_soal', 'gaya_soal', 'format_bank_soal', 'format_output_ai', 'sertakan_kunci_jawaban',
        ...
        function generatePromptBankSoal() {
            ...
            const formatOutputAi = document.getElementById('format_output_ai').value;
            ...
            const instruksiOutputFile = formatOutputAi.startsWith('File Microsoft Word')
                ? `WAJIB membuat hasil akhir sebagai berkas Microsoft Word (.docx) yang rapi dan siap diunduh. Buat serta lampirkan berkas .docx tersebut sebagai output utama; JANGAN hanya menampilkan seluruh hasil sebagai teks di percakapan. Gunakan judul dan subjudul yang jelas, tabel yang tidak terpotong, tata letak halaman yang konsisten, serta tempatkan kunci jawaban, pembahasan, dan pedoman penskoran sesuai pilihan pengguna. Setelah berkas selesai dibuat, berikan tautan atau tombol untuk mengunduh file .docx.`
                : `Tampilkan hasil lengkap langsung di percakapan AI dengan susunan yang rapi dan tanpa bagian terpotong.`;
...
- Format Output AI: ${formatOutputAi}
